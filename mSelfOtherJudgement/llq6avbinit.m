function [l,dl,dsurr] = llq6avbinit(x,D,mu,nui,doprior,options);
%
% [l,dl,surrugatedata] = llq6avb(x,D,mu,nui,doprior,options);
%
...
for t=1:length(a);
	if ~isnan(a(t));
		...
		wv = (-wordval(t)+3)/2;
		q0 = Q(:,wv,av(t));
		q0(1) = q0(1) + selfposbias(bl)*wordval(t) + wordval(t)*initb;
