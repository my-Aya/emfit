function [l,dl,dsurr] = lld6avbnowords(x,D,mu,nui,doprior,options);
%
% [l,dl,surrugatedata] = lld6avbnowords(x,D,mu,nui,doprior,options);
%
...
for t=1:length(a);
	if ~isnan(a(t));
		...
		if dodiff
			...
			dqdr(3-a(t),av(t)) = dqdr(3-a(t),av(t)) + alpha*(-rho*r(t) - dqdr(3-a(t),av(t)));
			dqda(a(t),av(t)) = dqda(a(t),av(t)) + alpha*(1-alpha)*(rho*r(t)-Q(a(t),av(t))) + alpha*(-dqda(a(t),av(t)));
			dqda(3-a(t),av(t)) = dqda(3-a(t),av(t)) + alpha*(1-alpha)*(-rho*r(t)-Q(3-a(t),av(t))) + alpha*(-dqda(3-a(t),av(t)));
		end

		Q(  a(t),av(t)) = Q(  a(t),av(t))+alpha*( rho*r(t)-Q(  a(t),av(t)));
		Q(3-a(t),av(t)) = Q(3-a(t),av(t))+alpha*(-rho*r(t)-Q(3-a(t),av(t)));
